        ...
        <table class="table">
            ...
            <tbody>
                @forelse ($consults as $key => $consult)
                    <tr>
                        <td class="text-center px-2 p-1 col-1"> <strong>{{ $consult->title }}</strong> </td>
                        <td class="text-center px-2 p-1 col-3"> {{ $consult->description }} </td>
                        ...
                        <td class="text-center px-2 p-1 col-2"> <div class="d-flex flex-column align-items-center"><span class="my-1">{{ $consult->doctor->name }} </span> <img class="styleImgPerfil my-2" src="{{ asset('storage/images/'. $consult->doctor->image) }}" alt=""></div> </td>
