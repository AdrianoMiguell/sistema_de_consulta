        ...
        <div class="bg-white position-absolute rounded p-4 bg-opacity-75">
            ...
            <form method="POST" action="{{ route('edit.consult', ['id' => $consults->id]) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $consults->description }}" type="text" class="form-control" id="description" aria-describedby="emailHelp" name="description">
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center my-3 mx-2">
                    <div class="d-flex align-items-center">
                        ...
                        <input value="{{ $consults->date }}" type="date" class="form-control" id="date"
                            aria-describedby="emailHelp" name="date">
                    </div>
                    <div class="d-flex align-items-center">
                        <label for="time" class="form-label" title="Nova hora da consulta"> Hora </label>
                        <input value="{{ $consults->hour }}" type="time" class="form-control ms-2" id="time"
                            aria-describedby="emailHelp" name="hour">
                    </div>
                </div>
